...
<div class="email-container" style="width: 650px; border: 1px solid #eee;">
    ...
    <div id="content" style="padding: 10px 15px;">
        ...
        <p>
            ...
            <br>
            <br>
            <strong>Final confirmation of your appointment date and time will be emailed to you once you reply to this email with the attached photo of your deposit slip within 3 working days. Failure to do so will result to the cancellation of your appointment schedule.</strong> 
            <br>            
            <br>            
            <span style="color:red">NOTE:</span> WE DO NOT ACCEPT BANK TRANSFERS OR REMITTANCES FROM BOTH FOREIGN AND LOCAL MONEY TRANSFER AGENCIES.<br> 
            Acceptable forms of payment are <span style="color:blue">OVER THE COUNTER CASH DEPOSIT</span> to below bank account details:
            <br>
            <br>
            ...
            <br>
            <ol>
                <li>You are required to wear <strong>SURGICAL MASK within the clinic's premises.</strong></li>
                ...
                <li><span style="color:blue">BRING YOUR ORIGINAL DEPOSIT SLIP</span> as proof of payment.</li>
